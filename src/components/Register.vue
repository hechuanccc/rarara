<template>
  <div class="bg-container">
    ...
    <el-dialog :append-to-body="true" title="服務協議" width="40%" :visible.sync="dialogVisible">
      <div class="agreement">
        <p>在此特别提醒用户认真阅读本《协议》中各条款内容，包括免除或者减少本公司责任的免责条款及用户的权利条款。请您审阅并选择接受或不接受本《协议》（未成年人应在法定监护人陪同下审阅）。用户对本协议的接受即受本公司与用户之间全部协议的约束，包括接受本公司对服务条款随时所做的任何修改。这些条款可由本公司随时更新，且无须另行通知。修改后的用户协议一旦在协议发布页面上公布即有效代替原来的用户协议，用户可随时登录官网查阅最新用户协议。
          如果不同意所改动的内容，用户可以主动取消或立即停止使用本公司提供的的网络服务。如果用户继续享用本公司提供的网络服务，则视为接受本公司对服务条款的变动。</p>
